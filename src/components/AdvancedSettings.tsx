...
const AdvancedSettings: React.FC = () => {
    ...
    return (
        <div className="w-full h-full bg-[#1E1E1E]/95 backdrop-blur-2xl overflow-hidden flex flex-col text-slate-200 select-none border border-white/10 shadow-2xl shadow-black/40 rounded-[18px] animate-scale-in origin-top-left">
            {/* Header */}
